    ...
    const workExperience = [
        {
            ...
            description: "Architected and delivered full-featured B2B and B2C web applications from scratch using React.js, Next.js, and with TypeScript, including complex admin dashboards for Towner and Business Admins with real-time analytics, user management, and trip monitoring Built key platform modules end-to-end — Trip Share, Landing Pages, Open Data Portal, Open Data Admin Dashboard, API Documentation Portal, and a real-time SOS alert system with live status updates Implemented real-time ride tracking interfaces using WebSockets supporting 17,000+ drivers and 20,000+ riders concurrently, with performance optimisations like lazy loading, code splitting, and efficient state management Built Role-Based Access Control (RBAC) with dynamic route guards and permission- based UI rendering across the platform Developed and delivered multiple business-facing dashboards for OIOT Solutions (a Towner subsidiary) — including the Channel Partner Dashboard, Distributor Panel, and OIOT Admin Dashboard — enabling partner onboarding, sales pipeline visibility, and distributor management workflows Developed a lead-generation platform for OIOT Solutions (a Towner subsidiary) Worked across a modern frontend stack including React.js, Next.js, TypeScript, Redis, and AWS deployment pipelines throughout the product lifecycle",
